...
As demonstrated, `range()` returns a vector with two values: the lowest and the highest.  We can manually compute the actual range using this values by substracting these two.  

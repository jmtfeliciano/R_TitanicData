...
`pie()` helped us create a beautiful pie chart.  But it did not print the numbers associated with them.  There are multiple ways of doing this.  But the easiest way is to create a custom label tag like below:

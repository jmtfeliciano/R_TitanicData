...
Arguably, R has the steepest learning curve for Data Scientists and Statisticians.  Once you are comfortable with it, R is very rewarding for Data Analysis.  But learning the many ways to represent your data using R is always the main challenge for beginners.  
...
IRQ, shorthand for interquartile range, is another measure of variability we often see in Statistics.  We can describe IQR as a measure of where the bulk of the values lie by substracting the first quartile value from the third quartile value. 

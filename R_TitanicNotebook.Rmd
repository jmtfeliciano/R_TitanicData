...
After running the script, indeed, `sort()` was able to sort our data in ascending order.  But let's extract the very last values since the values are the ones were are interested in.

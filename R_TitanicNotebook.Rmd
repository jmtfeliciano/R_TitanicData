...
Mode is perhaps the least metric used among the three central tendencies discussed in this tutorial.  By definition, it is a metric to describe the most occuring results in a variable.  It is not commonly used that there's not a built in R function to handle Mode. For this, we would need to create a function from scratch:  

...
IRQ, shorthand for interquartile range, is another measure of variability we often see in Statistics. The inter-quartile range is a measure that indicates the extent to which the central 50% of values within the dataset are dispersed. We can describe IQR as a measure of where the bulk of the values lie by substracting the first quartile value from the third quartile value. 

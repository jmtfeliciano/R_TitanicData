...
As demonstrated, `range()` returns a vector with two values: the lowest and the highest.  We can manually compute the actual range using this values. 

// TO DO:  ADD [0] [1] notation here for range to actually substract
